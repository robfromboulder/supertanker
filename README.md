...
[![Contributing](https://img.shields.io/badge/contributions-welcome-green.svg)](https://github.com/robfromboulder/supertanker/blob/v6.3.x/CONTRIBUTING.md)
...
services:
  supertanker:
    ...
    image: "robfromboulder/supertanker:6.3.2a"
    environment:
