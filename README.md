...
[![Contributing](https://img.shields.io/badge/contributions-welcome-green.svg)](https://github.com/robfromboulder/supertanker/blob/v7.0.x/CONTRIBUTING.md)
...
services:
  supertanker:
    ...
    image: "robfromboulder/supertanker:7.0.beta3"
    environment:
